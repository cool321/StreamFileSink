...
public final class DefaultRollingPolicy<IN, BucketID> implements RollingPolicy<IN, BucketID> {
    ...
    private static final long DEFAULT_ROLLOVER_INTERVAL = 10L * 1000L;

    private static final long DEFAULT_MAX_PART_SIZE = 1024L * 1024L * 128L*10;
...
//        System.out.println(partFileState.getSize());
     ...
     */
    public static org.apache.flink.streaming.api.functions.sink.filesystem.rollingpolicies.DefaultRollingPolicy.PolicyBuilder create() {
        return new org.apache.flink.streaming.api.functions.sink.filesystem.rollingpolicies.DefaultRollingPolicy.PolicyBuilder(
    ...
    /**
     * A helper class that holds the configuration properties for the {@link org.apache.flink.streaming.api.functions.sink.filesystem.rollingpolicies.DefaultRollingPolicy}.
     */
    @PublicEvolving
    public static final class PolicyBuilder {
         ...
         */
        public org.apache.flink.streaming.api.functions.sink.filesystem.rollingpolicies.DefaultRollingPolicy.PolicyBuilder withMaxPartSize(final long size) {
         ...
         */
        public org.apache.flink.streaming.api.functions.sink.filesystem.rollingpolicies.DefaultRollingPolicy.PolicyBuilder withInactivityInterval(final long interval) {
         ...
         */
        public org.apache.flink.streaming.api.functions.sink.filesystem.rollingpolicies.DefaultRollingPolicy.PolicyBuilder withRolloverInterval(final long interval) {
            Preconditions.checkState(interval > 0L);
         ...
         */
        public <IN, BucketID> org.apache.flink.streaming.api.functions.sink.filesystem.rollingpolicies.DefaultRollingPolicy<IN, BucketID> build() {
            return new org.apache.flink.streaming.api.functions.sink.filesystem.rollingpolicies.DefaultRollingPolicy<>(partSize, rolloverInterval, inactivityInterval);
        }
    }
}
