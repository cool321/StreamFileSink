...
public class StreamingFileSink<IN>
    ...
    //生成buckets，同时获取状态bucketStates、maxPartCountersState的初始值
    //如果是从失败中恢复任务的话，则利用恢复的状态更新buckets中相应的属性值
    @Override
    public void initializeState(FunctionInitializationContext context) throws Exception {
        ...
        if (context.isRestored()) {
            //从checkpoint中恢复，利用恢复的state更新buckets中相应的属性值
    ...
    public void onProcessingTime(long timestamp) throws Exception {
        ...
        buckets.onProcessingTime(currentTime); //最终调用的是bucket的onProcessingTime(currentTime)方法
